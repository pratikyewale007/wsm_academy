...
const Basic_class = () => {
    ...
    return (
        <section className="container py-5">
            ...
            <h3 className="fw-bold comptitles">BASIC OF STOCK MARKET</h3>
            <h5 className="fw-semibold text-secondary">Basic Class Of Stock Market For Beginners</h5>
