...
const Intraday_masterclass = () => {
    ...
    return (
        <section className="container py-5">
            ...
            <h3 className="fw-bold comptitles">INTRADAY TRADING MASTERCLASS</h3>
            <h5 className="fw-semibold text-secondary">Advanced Class For Complete Intraday Trading Of Stocks</h5>
            ...
            <div className="container py-4">
                <div className="d-flex justify-content-around flex-wrap text-center">
                    <div>
                        ...
                        <p>30 Days | 24 Online Interactive Sessions </p>
                    </div>
                    <div>
...
export default Intraday_masterclass
