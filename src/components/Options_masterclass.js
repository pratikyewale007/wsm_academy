...
const Options_masterclass = () => {
    ...
    return (
        <section className="container py-5">
            ...
            <h3 className="fw-bold comptitles">OPTION TRADING MASTERCLASS</h3>
            <h5 className="fw-semibold text-secondary">Advanced Class For Complete Indices & Stock Option Trading</h5>
            ...
            <div className="container py-4">
                <div className="d-flex justify-content-around flex-wrap text-center">
                    <div>
                        ...
                        <p>60 days | 42 Online Interactive Sessions</p>
                    </div>
                    <div>
...
export default Options_masterclass
